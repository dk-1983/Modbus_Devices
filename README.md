...
| Bolid | [С2000-СМК исп.04](https://bolid.ru/production/amrs/addr-amrs-detection-hdw/) | С2000-ПП → С2000-КДЛ → DPLS | Lossless opening multistate state | Wired one-address execution; no battery, radio, tamper, or derived opening binary entity; active contact routing awaits hardware validation |
