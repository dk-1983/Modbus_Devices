...
## Новое в 1.1.0 — управление климатом

В этом релизе появились первые сущности Home Assistant `climate` в Modbus
...
оборудования через RAW TCP-шлюз. Карточки добавляются на панель вручную по желанию.

## Основные возможности

- Modbus TCP/IP, native Modbus UDP/IP, последовательный Modbus RTU, Modbus RTU over UDP и Modbus RTU over TCP.
- Явно описанные модели оборудования Bolid, Daikin, Dyna Drive, Haier, Owen и Zuked.
