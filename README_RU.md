...
- Настройка через интерфейс, локализация на русском/английском и генератор нативной карточки.
...
| С2000-ПП | Прямой Modbus-шлюз | Состояние шлюза и привязка подчинённого оборудования |
| С2000-КПБ | С2000-ПП / Orion | Настроенные состояния выходов и цепей, поддерживаемое управление |
| С2000-2 | С2000-ПП / Orion | Состояния прибора, входов и доступа |
| С2000-4 | С2000-ПП / Orion | Состояние прибора и настроенных входов |
| Сигнал-20М | С2000-ПП / Orion | Состояние прибора и настроенных входов |
| С2000-БКИ | С2000-ПП / Orion | Диагностическое состояние прибора |
| МИП-24 исп.20 | С2000-ПП / Orion | Мультисостояния системы питания |
...
| ДИП-34А-05 | С2000-ПП / ДПЛС | Состояние дымового извещателя и динамическая индикация |
| С2000-ИП-03 | С2000-ПП / ДПЛС | Состояние теплового извещателя и поддерживаемые измерения |
| С2000-ДЗ | С2000-ПП / ДПЛС | Состояние дымовой зоны и диагностика |
...
| С2000-ВТ | С2000-ПП / ДПЛС | Температура и состояние |
| С2000-ВТИ | С2000-ПП / ДПЛС | Температура, влажность и состояние |
...
| СВК15-3-2-Б | С2000-ПП / ДПЛС | Состояние водосчётчика и поддерживаемые данные счёта |
...
| С2000Р-РМ | С2000-ПП / АРР/КДЛ | Состояние выходов/реле и поддерживаемое управление |
| С2000Р-Сирена | С2000-ПП / АРР/КДЛ | Состояние оповещателя и диагностика |
| С2000Р-СТ исп.01 | С2000-ПП / АРР/КДЛ | Разбитие стекла/тревога, вскрытие и диагностика батареи |
| С2000Р-СМК | С2000-ПП / АРР/КДЛ | Контакт/тревога, вскрытие, батарея и состояние внешнего входа |
| С2000Р-ДЗ | С2000-ПП / АРР/КДЛ | Состояние дымовой зоны и диагностика |
| С2000Р-ВТИ | С2000-ПП / АРР/КДЛ | Температура, влажность и диагностика |
...
| Модель | Подключение | Основные возможности |
|---|---|---|
| ПЛК110-24.60.К-М | Прямой Modbus | Настраиваемые дискретные входы и выходы-переключатели |
| ТРМ-138 | Прямой Modbus | Восьмиканальный контроль температуры и диагностика |
...
<p align="center"><img src="pictures/custom_card/entities_preview.jpg" alt="Проверка созданной нативной карточки Entities" width="88%"></p>

<p align="center"><img src="pictures/custom_card/dashboard_result.jpg" alt="Сохранённая нативная карточка Entities" width="88%"></p>

После сохранения результат является обычной нативной карточкой Home Assistant `type: entities`. Постоянной runtime-обёртки Modbus Devices нет, карточку можно редактировать как обычно.
...
- Runtime-прошивка, серийный номер, радиоадрес, RSSI и похожие метаданные показываются только когда их действительно можно прочитать.
