...
Канонический registry текущего исходного кода содержит **31 моделей: Bolid 28, Dyna Drive 1 и Owen 2**. Названия ниже — пользовательские названия производителя, а не имена Python-классов.
